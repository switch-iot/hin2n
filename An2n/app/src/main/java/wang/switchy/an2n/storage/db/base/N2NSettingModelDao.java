package wang.switchy.an2n.storage.db.base;
...
public class N2NSettingModelDao extends AbstractDao<N2NSettingModel, Long> {
    ...
    public static class Properties {
        ...
        public final static Property LocalIP = new Property(11, String.class, "localIP", false, "LOCAL_IP");
        public final static Property HolePunchInterval = new Property(12, int.class, "holePunchInterval", false, "HOLE_PUNCH_INTERVAL");
        public final static Property ResoveSupernodeIP = new Property(13, boolean.class, "resoveSupernodeIP", false, "RESOVE_SUPERNODE_IP");
        public final static Property LocalPort = new Property(14, int.class, "localPort", false, "LOCAL_PORT");
        public final static Property AllowRouting = new Property(15, boolean.class, "allowRouting", false, "ALLOW_ROUTING");
        public final static Property DropMuticast = new Property(16, boolean.class, "dropMuticast", false, "DROP_MUTICAST");
        public final static Property TraceLevel = new Property(17, int.class, "traceLevel", false, "TRACE_LEVEL");
        public final static Property IsSelcected = new Property(18, boolean.class, "isSelcected", false, "IS_SELCECTED");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"N2NSettingList\" (" + //
                ...
                "\"LOCAL_IP\" TEXT," + // 11: localIP
                "\"HOLE_PUNCH_INTERVAL\" INTEGER NOT NULL ," + // 12: holePunchInterval
                "\"RESOVE_SUPERNODE_IP\" INTEGER NOT NULL ," + // 13: resoveSupernodeIP
                "\"LOCAL_PORT\" INTEGER NOT NULL ," + // 14: localPort
                "\"ALLOW_ROUTING\" INTEGER NOT NULL ," + // 15: allowRouting
                "\"DROP_MUTICAST\" INTEGER NOT NULL ," + // 16: dropMuticast
                "\"TRACE_LEVEL\" INTEGER NOT NULL ," + // 17: traceLevel
                "\"IS_SELCECTED\" INTEGER NOT NULL );"); // 18: isSelcected
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, N2NSettingModel entity) {
        ...
        if (localIP != null) {
            stmt.bindString(12, localIP);
        }
        stmt.bindLong(13, entity.getHolePunchInterval());
        stmt.bindLong(14, entity.getResoveSupernodeIP() ? 1L: 0L);
        stmt.bindLong(15, entity.getLocalPort());
        stmt.bindLong(16, entity.getAllowRouting() ? 1L: 0L);
        stmt.bindLong(17, entity.getDropMuticast() ? 1L: 0L);
        stmt.bindLong(18, entity.getTraceLevel());
        stmt.bindLong(19, entity.getIsSelcected() ? 1L: 0L);
    }
    ...
    public N2NSettingModel readEntity(Cursor cursor, int offset) {
        N2NSettingModel entity = new N2NSettingModel( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), // localIP
            cursor.getInt(offset + 12), // holePunchInterval
            cursor.getShort(offset + 13) != 0, // resoveSupernodeIP
            cursor.getInt(offset + 14), // localPort
            cursor.getShort(offset + 15) != 0, // allowRouting
            cursor.getShort(offset + 16) != 0, // dropMuticast
            cursor.getInt(offset + 17), // traceLevel
            cursor.getShort(offset + 18) != 0 // isSelcected
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, N2NSettingModel entity, int offset) {
        ...
        entity.setLocalIP(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
        entity.setHolePunchInterval(cursor.getInt(offset + 12));
        entity.setResoveSupernodeIP(cursor.getShort(offset + 13) != 0);
        entity.setLocalPort(cursor.getInt(offset + 14));
        entity.setAllowRouting(cursor.getShort(offset + 15) != 0);
        entity.setDropMuticast(cursor.getShort(offset + 16) != 0);
        entity.setTraceLevel(cursor.getInt(offset + 17));
        entity.setIsSelcected(cursor.getShort(offset + 18) != 0);
     }
